(function (root, factory) {
  ...
  var gridArea = kotlin_org_jetbrains_compose_html_html_core.$_$.o1;
  var Companion_instance = kotlin_org_jetbrains_compose_html_html_core.$_$.b;
  var alignItems = kotlin_org_jetbrains_compose_html_html_core.$_$.y;
  ...
  var alignSelf = kotlin_org_jetbrains_compose_html_html_core.$_$.z;
  ...
  var flexDirection = kotlin_org_jetbrains_compose_html_html_core.$_$.j1;
  var Companion_instance_5 = kotlin_org_jetbrains_compose_html_html_core.$_$.h;
  var justifyContent = kotlin_org_jetbrains_compose_html_html_core.$_$.u1;
  var flexGrow = kotlin_org_jetbrains_compose_html_html_core.$_$.k1;
  ...
  var coerceIn = kotlin_kotlin.$_$.o6;
  ...
  var backgroundColor = kotlin_org_jetbrains_compose_html_html_core.$_$.a1;
  ...
  var borderRadius = kotlin_org_jetbrains_compose_html_html_core.$_$.b1;
  var border = kotlin_org_jetbrains_compose_html_html_core.$_$.c1;
  ...
  var color = kotlin_org_jetbrains_compose_html_html_core.$_$.g1;
  var opacity = kotlin_org_jetbrains_compose_html_html_core.$_$.c2;
  var appearance = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.h;
  var gap = kotlin_org_jetbrains_compose_html_html_core.$_$.n1;
  var fontWeight = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.t;
  var fontSize = kotlin_org_jetbrains_compose_html_html_core.$_$.l1;
  ...
  var lineHeight = kotlin_org_jetbrains_compose_html_html_core.$_$.w1;
  ...
  var position = kotlin_org_jetbrains_compose_html_html_core.$_$.f2;
  var top = kotlin_org_jetbrains_compose_html_html_core.$_$.j2;
  var left = kotlin_org_jetbrains_compose_html_html_core.$_$.v1;
  var right = kotlin_org_jetbrains_compose_html_html_core.$_$.h2;
  var bottom = kotlin_org_jetbrains_compose_html_html_core.$_$.d1;
  var get_percent = kotlin_org_jetbrains_compose_html_html_core.$_$.e2;
  var width = kotlin_org_jetbrains_compose_html_html_core.$_$.m2;
  var minWidth = kotlin_org_jetbrains_compose_html_html_core.$_$.a2;
  var height = kotlin_org_jetbrains_compose_html_html_core.$_$.t1;
  var minHeight = kotlin_org_jetbrains_compose_html_html_core.$_$.z1;
  ...
  function Box(modifier, contentAlignment, ref, content, $composer, $changed, $default) {
    ...
    $composer_0 = $composer_0.c19(287459556);
    var $dirty = $changed;
    if (!(($default & 1) === 0))
      $dirty = $dirty | 6;
    ...
    if (!(($default & 8) === 0))
      ...
      $dirty = $dirty | ($composer_0.g18(content_0._v) ? 2048 : 1024);
    if (!(($dirty & 5851) === 1170) ? true : !$composer_0.g17()) {
      if (!(($default & 1) === 0)) {
      ...
      if (!(($default & 8) === 0)) {
        content_0._v = ComposableSingletons$BoxKt_getInstance().p2f_1;
      }
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.a1e(Box$lambda_0(modifier_0, contentAlignment_0, ref_0, content_0, $changed, $default));
    }
  }
  ...
  function ComposableSingletons$BoxKt$lambda_1$lambda_ab4h0h($this$null, $composer, $changed) {
    var $composer_0 = $composer;
    if (!(($changed & 81) === 16) ? true : !$composer_0.g17()) {
      if (isTraceInProgress()) {
  ...
  function ComposableSingletons$BoxKt() {
    ...
    var tmp = this;
    tmp.p2f_1 = ComposableLambda$invoke$ref(composableLambdaInstance(-1088174424, false, ComposableSingletons$BoxKt$lambda_1$lambda_ab4h0h));
  }
  ...
  function boxClasses(_this__u8e3s4, contentAlignment) {
    contentAlignment = contentAlignment === VOID ? BoxDefaults_getInstance().q2f_1 : contentAlignment;
  ...
  function rowClasses(_this__u8e3s4, horizontalArrangement, verticalAlignment) {
    horizontalArrangement = horizontalArrangement === VOID ? RowDefaults_getInstance().r2f_1 : horizontalArrangement;
    verticalAlignment = verticalAlignment === VOID ? RowDefaults_getInstance().s2f_1 : verticalAlignment;
    return classNames(_this__u8e3s4, ['kobweb-row', toClassName_1(horizontalArrangement), toClassName(verticalAlignment)]);
  }
  function RowDefaults() {
    RowDefaults_instance = this;
    this.r2f_1 = Start_instance;
    this.s2f_1 = Top_instance;
  }
    ...
    if (equals(_this__u8e3s4, End_instance)) {
      ...
      if (equals(_this__u8e3s4, Start_instance)) {
        ...
        if (isInterface(_this__u8e3s4, HorizontalOrVertical)) {
          tmp = toClassName_2(_this__u8e3s4);
        } else {
          noWhenBranchMatchedException();
        }
      }
  ...
  function initBox($this) {
    $this.e27('.kobweb-box', KobwebComposeStyleSheet$initBox$lambda);
    $this.e27('.kobweb-box > *', KobwebComposeStyleSheet$initBox$lambda_0);
    $this.e27('.kobweb-box.kobweb-align-top-start', KobwebComposeStyleSheet$initBox$lambda_1);
    $this.e27('.kobweb-box.kobweb-align-top-center', KobwebComposeStyleSheet$initBox$lambda_2);
    $this.e27('.kobweb-box.kobweb-align-top-end', KobwebComposeStyleSheet$initBox$lambda_3);
    $this.e27('.kobweb-box.kobweb-align-center-start', KobwebComposeStyleSheet$initBox$lambda_4);
    $this.e27('.kobweb-box.kobweb-align-center', KobwebComposeStyleSheet$initBox$lambda_5);
    $this.e27('.kobweb-box.kobweb-align-center-end', KobwebComposeStyleSheet$initBox$lambda_6);
    $this.e27('.kobweb-box.kobweb-align-bottom-start', KobwebComposeStyleSheet$initBox$lambda_7);
    $this.e27('.kobweb-box.kobweb-align-bottom-center', KobwebComposeStyleSheet$initBox$lambda_8);
    $this.e27('.kobweb-box.kobweb-align-bottom-end', KobwebComposeStyleSheet$initBox$lambda_9);
    $this.e27('.kobweb-box > .kobweb-align-top-start-self', KobwebComposeStyleSheet$initBox$lambda_10);
    $this.e27('.kobweb-box > .kobweb-align-top-center-self', KobwebComposeStyleSheet$initBox$lambda_11);
    $this.e27('.kobweb-box > .kobweb-align-top-end-self', KobwebComposeStyleSheet$initBox$lambda_12);
    $this.e27('.kobweb-box > .kobweb-align-center-start-self', KobwebComposeStyleSheet$initBox$lambda_13);
    $this.e27('.kobweb-box > .kobweb-align-center-self', KobwebComposeStyleSheet$initBox$lambda_14);
    $this.e27('.kobweb-box > .kobweb-align-center-end-self', KobwebComposeStyleSheet$initBox$lambda_15);
    $this.e27('.kobweb-box > .kobweb-align-bottom-start-self', KobwebComposeStyleSheet$initBox$lambda_16);
    $this.e27('.kobweb-box > .kobweb-align-bottom-center-self', KobwebComposeStyleSheet$initBox$lambda_17);
    $this.e27('.kobweb-box > .kobweb-align-bottom-end-self', KobwebComposeStyleSheet$initBox$lambda_18);
  }
  function initRow($this) {
    $this.e27('.kobweb-row', KobwebComposeStyleSheet$initRow$lambda);
    $this.e27('.kobweb-row.kobweb-arrange-start', KobwebComposeStyleSheet$initRow$lambda_0);
    $this.e27('.kobweb-row.kobweb-arrange-center', KobwebComposeStyleSheet$initRow$lambda_1);
    $this.e27('.kobweb-row.kobweb-arrange-end', KobwebComposeStyleSheet$initRow$lambda_2);
    $this.e27('.kobweb-row.kobweb-arrange-space-evenly', KobwebComposeStyleSheet$initRow$lambda_3);
    $this.e27('.kobweb-row.kobweb-arrange-space-between', KobwebComposeStyleSheet$initRow$lambda_4);
    $this.e27('.kobweb-row.kobweb-arrange-space-around', KobwebComposeStyleSheet$initRow$lambda_5);
    $this.e27('.kobweb-row.kobweb-align-top', KobwebComposeStyleSheet$initRow$lambda_6);
    $this.e27('.kobweb-row.kobweb-align-center-vert', KobwebComposeStyleSheet$initRow$lambda_7);
    $this.e27('.kobweb-row.kobweb-align-bottom', KobwebComposeStyleSheet$initRow$lambda_8);
    $this.e27('.kobweb-row > .kobweb-align-top-self', KobwebComposeStyleSheet$initRow$lambda_9);
    $this.e27('.kobweb-row > .kobweb-align-center-vert-self', KobwebComposeStyleSheet$initRow$lambda_10);
    $this.e27('.kobweb-row > .kobweb-align-bottom-self', KobwebComposeStyleSheet$initRow$lambda_11);
  }
  function initCol($this) {
    $this.e27('.kobweb-col', KobwebComposeStyleSheet$initCol$lambda);
    $this.e27('.kobweb-col.kobweb-arrange-top', KobwebComposeStyleSheet$initCol$lambda_0);
    $this.e27('.kobweb-col.kobweb-arrange-center', KobwebComposeStyleSheet$initCol$lambda_1);
    $this.e27('.kobweb-col.kobweb-arrange-bottom', KobwebComposeStyleSheet$initCol$lambda_2);
    $this.e27('.kobweb-col.kobweb-arrange-space-evenly', KobwebComposeStyleSheet$initCol$lambda_3);
    $this.e27('.kobweb-col.kobweb-arrange-space-between', KobwebComposeStyleSheet$initCol$lambda_4);
    $this.e27('.kobweb-col.kobweb-arrange-space-around', KobwebComposeStyleSheet$initCol$lambda_5);
    $this.e27('.kobweb-col.kobweb-align-start', KobwebComposeStyleSheet$initCol$lambda_6);
    $this.e27('.kobweb-col.kobweb-align-center-horiz', KobwebComposeStyleSheet$initCol$lambda_7);
    $this.e27('.kobweb-col.kobweb-align-end', KobwebComposeStyleSheet$initCol$lambda_8);
    $this.e27('.kobweb-col > .kobweb-align-start-self', KobwebComposeStyleSheet$initCol$lambda_9);
    $this.e27('.kobweb-col > .kobweb-align-center-horiz-self', KobwebComposeStyleSheet$initCol$lambda_10);
    $this.e27('.kobweb-col > .kobweb-align-end-self', KobwebComposeStyleSheet$initCol$lambda_11);
  }
  function initSpacer($this) {
    $this.e27('.kobweb-spacer', KobwebComposeStyleSheet$initSpacer$lambda);
  }
  ...
  function KobwebComposeStyleSheet$initBox$lambda$lambda($this$grid) {
    $this$grid.e2a(KobwebComposeStyleSheet$initBox$lambda$lambda$lambda);
    $this$grid.f2a(KobwebComposeStyleSheet$initBox$lambda$lambda$lambda_0);
    return Unit_instance;
  }
  function KobwebComposeStyleSheet$initBox$lambda$lambda$lambda($this$columns) {
    $this$columns.o29(get_px(0), get_fr(1));
    return Unit_instance;
  }
  function KobwebComposeStyleSheet$initBox$lambda$lambda$lambda_0($this$rows) {
    $this$rows.o29(get_px(0), get_fr(1));
    return Unit_instance;
  }
  ...
  function KobwebComposeStyleSheet$initBox$lambda_1($this$invoke) {
    ...
    justifyItems($this$invoke, Companion_instance_0.s28());
    return Unit_instance;
  }
  function KobwebComposeStyleSheet$initBox$lambda_2($this$invoke) {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    alignItems($this$invoke, 'start');
    justifyItems($this$invoke, Companion_instance_0.r28());
    return Unit_instance;
  }
  function KobwebComposeStyleSheet$initBox$lambda_3($this$invoke) {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    alignItems($this$invoke, 'start');
    justifyItems($this$invoke, Companion_instance_0.t28());
    return Unit_instance;
  }
  ...
  function KobwebComposeStyleSheet$initBox$lambda_10($this$invoke) {
    ...
    justifySelf($this$invoke, Companion_instance_2.s28());
    return Unit_instance;
  }
  function KobwebComposeStyleSheet$initBox$lambda_11($this$invoke) {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    alignSelf($this$invoke, 'start');
    justifySelf($this$invoke, Companion_instance_2.r28());
    return Unit_instance;
  }
  function KobwebComposeStyleSheet$initBox$lambda_12($this$invoke) {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    alignSelf($this$invoke, 'start');
    justifySelf($this$invoke, Companion_instance_2.t28());
    return Unit_instance;
  }
  ...
  protoOf(KobwebComposeStyleSheet).c27 = function (selector, cssRule) {
  ...
  protoOf(Companion).y2f = function (initial, operation) {
    return initial;
  };
  protoOf(Companion).z2f = function (other) {
    return other;
  };
  ...
  protoOf(ChainedModifier).y2f = function (initial, operation) {
    return this.b2g_1.y2f(this.a2g_1.y2f(initial, operation), operation);
  };
  protoOf(ChainedModifier).equals = function (other) {
    var tmp;
    var tmp_0;
    if (other instanceof ChainedModifier) {
      tmp_0 = equals(this.a2g_1, other.a2g_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = equals(this.b2g_1, other.b2g_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  protoOf(ChainedModifier).hashCode = function () {
    return hashCode(this.a2g_1) + imul(31, hashCode(this.b2g_1)) | 0;
  };
  ...
  function styleModifier(_this__u8e3s4, styles) {
    return _this__u8e3s4.z2f(new StyleModifier(styles));
  }
  ...
  protoOf(StyleModifier).equals = function (other) {
    ...
    this.d2g_1(stylesResolved);
    var otherStylesResolved = new ComparableStyleScope();
    other.d2g_1(otherStylesResolved);
  ...
  function attrsModifier(_this__u8e3s4, attrs) {
    return _this__u8e3s4.z2f(new AttrsModifier(attrs));
  }
  function toAttrs$lambda$lambda$lambda($element) {
    return function ($this$style) {
      $element.d2g_1($this$style);
      return Unit_instance;
    };
  }
  function toAttrs$lambda$lambda($this_null) {
    return function (_anonymous_parameter_0__qggqh8, element) {
      ...
      if (element instanceof AttrsModifier) {
        tmp = element.c2g_1($this_null);
      } else {
        if (element instanceof StyleModifier) {
          $this_null.e24(toAttrs$lambda$lambda$lambda(element));
          tmp = Unit_instance;
        }
      }
      return Unit_instance;
  ...
  function toAttrs$lambda($firstModifier, $finalHandler) {
    return function ($this$null) {
      $firstModifier.y2f(Unit_instance, toAttrs$lambda$lambda($this$null));
  ...
  function toStyles$lambda($firstModifier, $finalHandler) {
    return function ($this$null) {
      $firstModifier.y2f(Unit_instance, toStyles$lambda$lambda($this$null));
      var tmp0_safe_receiver = $finalHandler;
      if (tmp0_safe_receiver == null)
        null;
      else
  ...
  protoOf(Rgb).f2g = function () {
    return this.e2g_1 >> 16 & 255;
  };
  protoOf(Rgb).g2g = function () {
    return this.e2g_1 >> 8 & 255;
  };
  protoOf(Rgb).h2g = function () {
    return this.e2g_1 >> 0 & 255;
  };
  protoOf(Rgb).i2g = function () {
    return this.e2g_1 >> 24 & 255;
  };
  protoOf(Rgb).j2g = function () {
    return toColorFloat(this.f2g());
  };
  protoOf(Rgb).k2g = function () {
    return toColorFloat(this.g2g());
  };
  protoOf(Rgb).l2g = function () {
    return toColorFloat(this.h2g());
  };
  protoOf(Rgb).m2g = function () {
    return toColorFloat(this.i2g());
  };
  protoOf(Rgb).n2g = function () {
    return Companion_instance_7.p2g(255 - this.f2g() | 0, 255 - this.g2g() | 0, 255 - this.h2g() | 0, this.i2g());
  };
  protoOf(Rgb).q2g = function (byPercent) {
    ...
    return Companion_instance_7.r2g(this.j2g() * darkeningMultiplier, this.k2g() * darkeningMultiplier, this.l2g() * darkeningMultiplier, this.m2g());
  };
  protoOf(Rgb).s2g = function (red, green, blue, alpha) {
    return Companion_instance_7.r2g(red, green, blue, alpha);
  };
  protoOf(Rgb).t2g = function (red, green, blue, alpha, $super) {
    red = red === VOID ? this.j2g() : red;
    green = green === VOID ? this.k2g() : green;
    blue = blue === VOID ? this.l2g() : blue;
    alpha = alpha === VOID ? this.m2g() : alpha;
    return $super === VOID ? this.s2g(red, green, blue, alpha) : $super.s2g.call(this, red, green, blue, alpha);
  };
  protoOf(Rgb).u2g = function () {
    return this;
  };
  protoOf(Rgb).toString = function () {
    return this.i2g() === 255 ? 'rgb(' + this.f2g() + ', ' + this.g2g() + ', ' + this.h2g() + ')' : 'rgba(' + this.f2g() + ', ' + this.g2g() + ', ' + this.h2g() + ', ' + this.m2g() + ')';
  };
  protoOf(Rgb).equals = function (other) {
    ...
    if (other instanceof Rgb) {
      tmp_2 = this.f2g() === other.f2g();
    } else {
      tmp_2 = false;
    }
    if (tmp_2) {
      tmp_1 = this.g2g() === other.g2g();
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = this.h2g() === other.h2g();
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.i2g() === other.i2g();
    } else {
      tmp = false;
    }
    return tmp;
  ...
  protoOf(Rgb).hashCode = function () {
    var result = this.f2g();
    result = imul(31, result) + this.g2g() | 0;
    result = imul(31, result) + this.h2g() | 0;
    result = imul(31, result) + this.i2g() | 0;
    return result;
  };
  function Companion_0() {
    this.o2g_1 = 0.3;
  }
  protoOf(Companion_0).v2g = function (value) {
    return new Rgb(-16777216 | value);
  };
  protoOf(Companion_0).w2g = function (r, g, b) {
    return this.p2g(r, g, b, 255);
  };
  protoOf(Companion_0).p2g = function (r, g, b, a) {
    return new Rgb((r & 255) << 16 | (g & 255) << 8 | (b & 255) << 0 | (a & 255) << 24);
  };
  protoOf(Companion_0).r2g = function (r, g, b, a) {
    return this.p2g(toColorInt(r), toColorInt(g), toColorInt(b), toColorInt(a));
  };
  ...
  protoOf(Colors).x2g = function () {
    return Companion_instance_7.p2g(0, 0, 0, 0);
  };
  protoOf(Colors).y2g = function () {
    return Companion_instance_7.w2g(0, 0, 0);
  };
  protoOf(Colors).z2g = function () {
    return Companion_instance_7.w2g(0, 0, 255);
  };
  protoOf(Colors).a2h = function () {
    return Companion_instance_7.w2g(100, 149, 237);
  };
  protoOf(Colors).b2h = function () {
    return Companion_instance_7.w2g(0, 255, 255);
  };
  protoOf(Colors).c2h = function () {
    return Companion_instance_7.w2g(169, 169, 169);
  };
  protoOf(Colors).d2h = function () {
    return Companion_instance_7.w2g(47, 79, 79);
  };
  protoOf(Colors).e2h = function () {
    return Companion_instance_7.w2g(30, 144, 255);
  };
  protoOf(Colors).f2h = function () {
    return Companion_instance_7.w2g(211, 211, 211);
  };
  protoOf(Colors).g2h = function () {
    return Companion_instance_7.w2g(135, 206, 250);
  };
  protoOf(Colors).h2h = function () {
    return Companion_instance_7.w2g(128, 0, 128);
  };
  protoOf(Colors).i2h = function () {
    return Companion_instance_7.w2g(238, 130, 238);
  };
  protoOf(Colors).j2h = function () {
    return Companion_instance_7.w2g(255, 255, 255);
  };
  protoOf(Colors).k2h = function () {
    return Companion_instance_7.w2g(245, 245, 245);
  };
  var Colors_instance;
  ...
  function lightened(_this__u8e3s4, byPercent) {
    ...
    return _this__u8e3s4.n2g().q2g(byPercent).n2g();
  }
  ...
  function BorderScope(styleScope) {
    this.l2h_1 = styleScope;
  }
  protoOf(BorderScope).m2h = function (color) {
    return borderColor(this.l2h_1, color);
  };
  protoOf(BorderScope).n2h = function (lineStyle) {
    return borderStyle(this.l2h_1, lineStyle);
  };
  protoOf(BorderScope).o2h = function (width) {
    return borderWidth(this.l2h_1, width);
  };
  ...
  function classNames$lambda($classes) {
    return function ($this$attrsModifier) {
      $this$attrsModifier.g24($classes.slice());
      return Unit_instance;
    };
  }
  ...
  function OverflowScope(styleScope) {
    this.p2h_1 = styleScope;
  }
  protoOf(OverflowScope).q2h = function (overflowY_0) {
    return overflowY(this.p2h_1, overflowY_0);
  };
  ...
  protoOf(ChainedModifier).z2f = then;
  protoOf(AttrsModifier).y2f = fold;
  protoOf(AttrsModifier).z2f = then;
  protoOf(StyleModifier).y2f = fold;
  protoOf(StyleModifier).z2f = then;
  //endregion
  //region block: init
  ...
  _.$_$.c = lightened;
  _.$_$.d = appearance_0;
  _.$_$.e = ariaDisabled_0;
  _.$_$.f = ariaHidden_0;
  _.$_$.g = backgroundColor_0;
  _.$_$.h = borderBottom_0;
  _.$_$.i = borderLeft_0;
  ...
  _.$_$.w1 = tabIndex;
  _.$_$.x1 = textAlign_0;
  _.$_$.y1 = textDecorationLine_0;
  _.$_$.z1 = top_0;
  _.$_$.a2 = transition_0;
  _.$_$.b2 = transition_1;
  _.$_$.c2 = translateX_0;
  _.$_$.d2 = userSelect_0;
  _.$_$.e2 = verticalAlign_0;
  _.$_$.f2 = whiteSpace_0;
  _.$_$.g2 = width_0;
  _.$_$.h2 = styleModifier;
  _.$_$.i2 = toAttrs;
  _.$_$.j2 = toStyles;
  _.$_$.k2 = KobwebComposeStyleSheet_getInstance;
  _.$_$.l2 = Companion_instance_7;
  _.$_$.m2 = Colors_instance;
  _.$_$.n2 = CenterVertically_instance;
  _.$_$.o2 = Center_instance_0;
  _.$_$.p2 = TopStart_instance;
  _.$_$.q2 = Companion_instance_6;
  //endregion
  return _;
}));
