(function (root, factory) {
  ...
  protoOf(AtomicRef).dg = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).eg = function () {
  ...
  protoOf(AtomicBoolean).fg = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).eg = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).gg = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).eg = function () {
    return this.kotlinx$atomicfu$value;
  };
