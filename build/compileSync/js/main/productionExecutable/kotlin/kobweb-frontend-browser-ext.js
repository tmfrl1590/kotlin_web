(function (root, factory) {
  ...
  var decapitalize = kotlin_kotlin.$_$.z6;
  var split = kotlin_kotlin.$_$.q7;
  ...
  function Companion() {
    ...
    this.is_1 = new CancellableActionHandle(0);
  }
  ...
  function CancellableActionHandle(id, isInterval) {
    ...
    this.js_1 = isInterval;
    this.ks_1 = id;
  }
  protoOf(CancellableActionHandle).ls = function () {
    if (this.js_1) {
      self.clearInterval(this.ks_1);
    } else {
      self.clearTimeout(this.ks_1);
    }
    this.ks_1 = 0;
  };
  function setInterval(_this__u8e3s4, delay, block) {
    var id = _this__u8e3s4.setInterval(block, _Duration___get_inWholeMilliseconds__impl__msfiry(delay).kb());
  ...
  function setTimeout(_this__u8e3s4, timeout, block) {
    var id = _this__u8e3s4.setTimeout(block, _Duration___get_inWholeMilliseconds__impl__msfiry(timeout).kb());
