(function (root, factory) {
  ...
  var setSilkWidgetVariables = kotlin_com_varabyte_kobweb_silk_widgets.$_$.g;
  var prepareSilkFoundation = kotlin_com_varabyte_kobweb_silk_foundation.$_$.d1;
  ...
  function SilkApp(content, $composer, $changed) {
    ...
    $composer_0 = $composer_0.c19(-1728416948);
    var $dirty = $changed;
    if (($changed & 14) === 0)
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.a1e(SilkApp$lambda_0(content, $changed));
    }
  }
